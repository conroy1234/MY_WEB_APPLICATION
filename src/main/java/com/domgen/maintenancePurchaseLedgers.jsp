...
{
	maintenancePurchaseLedgersForm.actionChosen.value= goTo;
	maintenancePurchaseLedgersForm.actionChosenType.value= "nav";
	maintenancePurchaseLedgersForm.submit();
}
function secondBarNavigation(goTo)
{
	maintenancePurchaseLedgersForm.actionChosen.value= goTo;
	maintenancePurchaseLedgersForm.actionChosenType.value= "func";
	maintenancePurchaseLedgersForm.submit();
}

function setActionDisplayYes(purchaseLedgerCodeSelected)
{
	maintenancePurchaseLedgersForm.actionChosen.value= "displayYes";
	maintenancePurchaseLedgersForm.actionChosenType.value= "func";
	maintenancePurchaseLedgersForm.purchaseLedgerCodeSelected.value = purchaseLedgerCodeSelected
	maintenancePurchaseLedgersForm.submit();
}
function setActionDisplayNo(purchaseLedgerCodeSelected)
{
	maintenancePurchaseLedgersForm.actionChosen.value= "displayNo";
	maintenancePurchaseLedgersForm.actionChosenType.value= "func";
	maintenancePurchaseLedgersForm.purchaseLedgerCodeSelected.value = purchaseLedgerCodeSelected
	maintenancePurchaseLedgersForm.submit();
}
function setActionDelete(purchaseLedgerCodeSelected)
{
	maintenancePurchaseLedgersForm.actionChosen.value= "delete";
	maintenancePurchaseLedgersForm.actionChosenType.value= "func";
	maintenancePurchaseLedgersForm.purchaseLedgerCodeSelected.value = purchaseLedgerCodeSelected
	maintenancePurchaseLedgersForm.submit();
}
...
{
	maintenancePurchaseLedgersForm.actionChosen.value= action;
	maintenancePurchaseLedgersForm.actionChosenType.value= "func";
}
</script>
...
<ul>
	...
	<li class="sectionSelected"><bean:message key="maintenancePurchaseLedgers.text" /></li>
	<!-- InstanceEndEditable -->
</ul>
</div>

<div id="content"><html:form action="/maintenancePurchaseLedgers.do" >

	<html:hidden property="actionChosen" value=""></html:hidden>
	<html:hidden property="actionChosenType" value=""></html:hidden>
	<html:hidden property="purchaseLedgerCodeSelected" value=""></html:hidden>
		
  <div id="mainContent"><!-- InstanceBeginEditable name="Page content" --> 
    <div class="box"> 
    	<h3 class="headingB"><bean:message key="maintenancePurchaseLedgers.Edit.text" /></h3>
  		<p><bean:message key="maintenancePurchaseLedgers.Edit.prompt.text" /><br><br></p>
...
<logic:iterate name="maintenanceAccountsResults" property="purchaseLedgers" id="purchaseLedgersID" indexId="i">

<tr>
		<td width="5%" valign="top"><html:text name="purchaseLedgersID" property="purchaseLedger"
					style="border:0; background-color:#E5EEF7;" size="6"
					readonly="true" indexed="true"><bean:write name="purchaseLedgersID" property="purchaseLedger"/></html:text></td>
		<td width="20%" valign="top"><html:text name="purchaseLedgersID" property="description"
					style="border:0; background-color:#E5EEF7;" size="30"
					readonly="true" indexed="true"><bean:write name="purchaseLedgersID" property="description"/></html:text></td>	
		<td width="15%" valign="top"><html:text name="purchaseLedgersID" property="displayFlag"
					style="border:0; background-color:#E5EEF7;" size="1"
					readonly="true" indexed="true"><bean:write name="purchaseLedgersID" property="displayFlag"/></html:text></td>
 		<td width="15%"><input type="submit" class="formButton" value="Yes" onClick="javascript:setActionDisplayYes('<bean:write name="purchaseLedgersID" property="purchaseLedger"/>');">&nbsp;<input type="submit" class="formButton" value="No" onClick="javascript:setActionDisplayNo('<bean:write name="purchaseLedgersID" property="purchaseLedger"/>');"></td>
		<td width="15%"><input type="submit" class="formButton" value="Delete" onClick="javascript:setActionDelete('<bean:write name="purchaseLedgersID" property="purchaseLedger"/>');"></td>
</tr>
</logic:iterate>
	...
	<div class="box"> 
 	<h3 class="headingB"><bean:message key="maintenancePurchaseLedgers.Create.text" /></h3>
  		<p><bean:message key="maintenancePurchaseLedgers.Create.prompt.text" /><br><br></p>
      <p>
