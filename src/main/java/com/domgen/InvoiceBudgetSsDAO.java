 ...
 */
public class InvoiceBudgetSsDAO extends BaseDAO implements ISelect, IDelete, IInsert, IUpdate
{
	...
	private static final String TABLE = "SCHDAYFILF.MBUNAUTHSS";
