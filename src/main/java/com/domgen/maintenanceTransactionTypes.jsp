...
{
	maintenanceTransactionTypesForm.actionChosen.value= goTo;
	maintenanceTransactionTypesForm.actionChosenType.value= "nav";
	maintenanceTransactionTypesForm.submit();
}
function secondBarNavigation(goTo)
{
	maintenanceTransactionTypesForm.actionChosen.value= goTo;
	maintenanceTransactionTypesForm.actionChosenType.value= "func";
	maintenanceTransactionTypesForm.submit();
}

function setActionDisplayYes(transactionTypeCodeSelected)
{
	maintenanceTransactionTypesForm.actionChosen.value= "displayYes";
	maintenanceTransactionTypesForm.actionChosenType.value= "func";
	maintenanceTransactionTypesForm.transactionTypeCodeSelected.value = transactionTypeCodeSelected
	maintenanceTransactionTypesForm.submit();
}
function setActionDisplayNo(transactionTypeCodeSelected)
{
	maintenanceTransactionTypesForm.actionChosen.value= "displayNo";
	maintenanceTransactionTypesForm.actionChosenType.value= "func";
	maintenanceTransactionTypesForm.transactionTypeCodeSelected.value = transactionTypeCodeSelected
	maintenanceTransactionTypesForm.submit();
}
function setActionDelete(transactionTypeCodeSelected)
{
	maintenanceTransactionTypesForm.actionChosen.value= "delete";
	maintenanceTransactionTypesForm.actionChosenType.value= "func";
	maintenanceTransactionTypesForm.transactionTypeCodeSelected.value = transactionTypeCodeSelected
	maintenanceTransactionTypesForm.submit();
}
...
{
	maintenanceTransactionTypesForm.actionChosen.value= action;
	maintenanceTransactionTypesForm.actionChosenType.value= "func";
}
</script>
...
<ul>
	...
	<li class="sectionSelected"><bean:message key="maintenanceTransactionTypes.text" /></li>
	<!-- InstanceEndEditable -->
</ul>
</div>

<div id="content"><html:form action="/maintenanceTransactionTypes.do" >

	<html:hidden property="actionChosen" value=""></html:hidden>
	<html:hidden property="actionChosenType" value=""></html:hidden>
	<html:hidden property="transactionTypeCodeSelected" value=""></html:hidden>
		
  <div id="mainContent"><!-- InstanceBeginEditable name="Page content" --> 
    <div class="box"> 
    	<h3 class="headingB"><bean:message key="maintenanceTransactionTypes.Edit.text" /></h3>
  		<p><bean:message key="maintenanceTransactionTypes.Edit.prompt.text" /><br><br></p>
...
<logic:iterate name="maintenanceAccountsResults" property="transactionTypes" id="transactionTypesID" indexId="i">

<tr>
		<td width="5%" valign="top"><html:text name="transactionTypesID" property="transactionType"
					style="border:0; background-color:#E5EEF7;" size="7"
					readonly="true" indexed="true"><bean:write name="transactionTypesID" property="transactionType"/></html:text></td>
		<td width="20%" valign="top"><html:text name="transactionTypesID" property="description"
					style="border:0; background-color:#E5EEF7;" size="30"
					readonly="true" indexed="true"><bean:write name="transactionTypesID" property="description"/></html:text></td>	
		<td width="15%" valign="top"><html:text name="transactionTypesID" property="displayFlag"
					style="border:0; background-color:#E5EEF7;" size="1"
					readonly="true" indexed="true"><bean:write name="transactionTypesID" property="displayFlag"/></html:text></td>
 		<td width="15%"><input type="submit" class="formButton" value="Yes" onClick="javascript:setActionDisplayYes('<bean:write name="transactionTypesID" property="transactionType"/>');">&nbsp;<input type="submit" class="formButton" value="No" onClick="javascript:setActionDisplayNo('<bean:write name="transactionTypesID" property="transactionType"/>');"></td>
				<td width="15%"><input type="submit" class="formButton" value="Delete" onClick="javascript:setActionDelete('<bean:write name="transactionTypesID" property="transactionType"/>');"></td>
</tr>
</logic:iterate>
	...
	<div class="box"> 
 	<h3 class="headingB"><bean:message key="maintenanceTransactionTypes.Create.text" /></h3>
  		<p><bean:message key="maintenanceTransactionTypes.Create.prompt.text" /><br><br></p>
      <p>
     <table width="90%" border="0" cellpadding="2" cellspacing="0">
	 <tr>
          <th width="40%" valign="top"><bean:message key="code.text" /> *</th>
          <td width="55%" valign="top"><html:text property="codeCreate" size="7" maxlength="6" tabindex="4"/>&nbsp;
