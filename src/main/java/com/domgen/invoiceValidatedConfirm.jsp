...
{
	invoiceValidatedConfirmForm.actionChosen.value= goTo;
	invoiceValidatedConfirmForm.actionChosenType.value= "nav";
	invoiceValidatedConfirmForm.submit();
}
function secondBarNavigation(goTo)
{
	invoiceValidatedConfirmForm.actionChosen.value= goTo;
	invoiceValidatedConfirmForm.actionChosenType.value= "func";
	invoiceValidatedConfirmForm.submit();
}
function setAction(action)
{
	invoiceValidatedConfirmForm.actionChosen.value= action;
	invoiceValidatedConfirmForm.actionChosenType.value= "func";
}
</script>
...
<ul>
	...
	<li><a href="#" onClick="secondBarNavigation('goToInvoiceValidatedSelection');return false;"><bean:message key="invoiceValidatedSelection.text" /></a>&nbsp;&gt;</li>	
	<li class="sectionSelected"><bean:message
		key="invoiceValidatedConfirm.navBar.text" /></li>
	<!-- InstanceEndEditable -->
</ul>
</div>

<div id="content"><html:form action="/invoiceValidatedConfirm.do">
	...
	<h3 class="headingB"><bean:message key="invoiceValidatedConfirm.text" />&nbsp;<bean:write name="invoiceValidatedResults" property="invoiceValidatedConfirmCount"/></h3>
	...
	<table border="0" cellpadding="2" cellspacing="0">
		...
		<TBODY>
			<logic:iterate name="invoiceValidatedResults" property="invoiceValidatedConfirm"
				id="invoiceValidatedConfirmID" indexId="i">

				<TR>
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="invoiceIdLineNo"/></td>
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="entryDateFormatted"/></td>
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="invoiceMonth"/>/20<bean:write name="invoiceValidatedConfirmID" property="invoiceYear"/></td>
					<td width="150" valign="top">
				<logic:equal name="invoiceValidatedConfirmID" property="financeDivision" value="DOM">
					<font color="blue"><bean:write name="invoiceValidatedConfirmID" property="invoiceNo"/>*<bean:write name="invoiceValidatedConfirmID" property="numberOfLines"/></font>
				</logic:equal>
				<logic:notEqual name="invoiceValidatedConfirmID" property="financeDivision" value="DOM">
					<bean:write name="invoiceValidatedConfirmID" property="invoiceNo"/>*<bean:write name="invoiceValidatedConfirmID" property="numberOfLines"/>
				</logic:notEqual>
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="smaReference"/></td>							
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="amountGross"/></td>									
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="approverUnderwriting"/></td>									
				<td width="150" valign="top"><bean:write name="invoiceValidatedConfirmID" property="approverSalesSupport"/></td>									
				</TR>
			</logic:iterate>
		</tbody>
	</table>
