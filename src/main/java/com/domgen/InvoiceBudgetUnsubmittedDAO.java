 ...
 */
public class InvoiceBudgetUnsubmittedDAO extends BaseDAO implements ISelect, IDelete, IInsert, IUpdate
{
	...
	private static final String TABLE = "SCHDAYFILF.MBUNSBMT3";
	 ...
	 *
	 */
	public InvoiceBudgetUnsubmittedDAO() 
	{
		super ();
	...
	{		
		...
		try
		{
			...
			if (rs.getString(ATTRIBUTE_FIELDS[12]) != null)
			{
			...
			{
				theVO.setInvoiceLineStatusText ("");	
				theVO.setInvoiceIdLineNo("");	
			}
//			try {
