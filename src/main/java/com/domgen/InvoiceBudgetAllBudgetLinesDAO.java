 ...
 */
public class InvoiceBudgetAllBudgetLinesDAO extends BaseDAO implements ISelect, IDelete, IInsert, IUpdate, IStatusCodes
{
	...
	private static final String TABLE = "SCHDAYFILF.MBUNSBMT2";
	 ...
	 *
	 */
	public InvoiceBudgetAllBudgetLinesDAO() 
	{
		super ();
